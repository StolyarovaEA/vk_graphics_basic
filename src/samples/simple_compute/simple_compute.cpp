...
void SimpleCompute::Execute()
{
  ...
  float mean1 = sum1 / values.size();
  auto end1   = std::chrono::high_resolution_clock::now();
  std::cout << "GPU" << std::endl;
  std::cout << "sum: " << sum1 << " ; size: " << values.size() << " ; mean: " << mean1 << std::endl;
  ...
  float mean2 = sum2 / m_B_C.size();
  auto end2   = std::chrono::high_resolution_clock::now();
  std::cout << "CPU" << std::endl;
  std::cout << "sum: " << sum2 << " ; size: " << m_B_C.size() << " ; mean: " << mean2 << std::endl;

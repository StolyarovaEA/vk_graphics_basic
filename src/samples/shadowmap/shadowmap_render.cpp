...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("simple_rsm", {VK_GRAPHICS_BASIC_ROOT"/resources/shaders/simple.vert.spv"});
}
  ...
  m_rsmPipeline          = pipelineManager.createGraphicsPipeline("simple_rsm",
    {
      .vertexShaderInput = sceneVertexInputDesc,
               ...
               .fragmentShaderOutput = { .colorAttachmentFormats = { vk::Format::eR32G32B32A32Sfloat, vk::Format::eR32G32B32A32Sfloat, vk::Format::eR8G8B8A8Srgb },
